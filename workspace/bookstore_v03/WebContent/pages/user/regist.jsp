						...
						<div class="login_box">
							...
							<div class="form">
								<form action="client/UserServlet?method=regist" method="post">
									<label>用户名称：</label>
									<input class="itxt" type="text" placeholder="请输入用户名" autocomplete="off" tabindex="1" <%=request.getParameter("username")==null?"":"value='"+request.getParameter("username")+"'"%> name="username" />
									<br />
									<br />
									<label>用户密码：</label>
									...
									<br />
									<label>电子邮件：</label>
									<input class="itxt" type="text" placeholder="请输入邮箱地址" autocomplete="off" tabindex="1" <%=request.getParameter("email")==null?"":"value='"+request.getParameter("email")+"'" %> name="email" />
									<br />
									<br />
									<label>验证码：</label>
