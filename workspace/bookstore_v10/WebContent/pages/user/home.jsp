...
<script type="text/javascript">
	...
	$(function(){
		...
		$("button").click(function(){
			//准备请求参数 
			//client/CartServlet?method=addBook2Cart&bookId=${book.id }
			var bookId = this.id;
			var url = "client/CartServlet?method=addBook2Cart&bookId="+bookId;
			//向服务器发送请求
			$.get(url,function(data){
				if(data){
					$(".info").empty().append("<span>您的购物车中有"+data.totalCount+"件商品</span><br>")
									.append("您刚刚将<span style='color: red'>"+data.title+"</span>加入到了购物车中");
				}
			},"json");
		});
	})
