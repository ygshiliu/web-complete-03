...
public class BookDaoImpl extends BaseDao<Book> implements BookDao {
	...
	@Override
	public int updateSalesAndStocks(int bookId, int sales, int stocks) {
		String sql = "update bs_books set sales=?,stocks=? where id=?";
		return update(sql, sales,stocks,bookId);
	}

	@Override
	public void batchUpdateSaleAndStock(Object[][] params) {
		String sql = "update bs_books set sales=?,stocks=? where id=?";
		batch(sql, params);
	}
